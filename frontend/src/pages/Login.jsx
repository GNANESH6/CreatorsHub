  ...
  return (
    <div className="glass-panel animate-fade-up" style={{ width: '100%', maxWidth: '400px' }}>
      <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
        <h1 className="heading-gradient animate-fade-up delay-100" style={{ fontSize: '2.5rem', marginBottom: '0.5rem' }}>
          Welcome Back
        </h1>
        <p className="animate-fade-up delay-200" style={{ color: 'var(--text-muted)' }}>
          Log in to continue building amazing things.
        </p>
      </div>
      ...
      <form onSubmit={handleLogin} className="animate-fade-up delay-300">
